...
public class OriginActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,
        MyListener
{
    ...
    private static final String LOG_TAG = OriginActivity.class.getSimpleName();
    ...
    public void onFinishRecognition(String result, String filepath) {
        try {
            String label = new File(filepath).getParentFile().getName();
